...
###################   END OF QT OUTPUT  ###########################
        ...
        #Action menus
        self.actionExit.triggered.connect(exit_program(self))
        self.actionAbout.triggered.connect(about_dialog(self))

        #Browse windows
        self.souce_folder_browse_pushButton.clicked.connect(folder_path_dialog(self))
        self.source_file_browse_pushButton.clicked.connect(file_path_dialog(self))
        ...
        #Start buttons
        self.start_clustering_pushButton.clicked.connect(start_clustering(self))
        self.compute_distances_pushButton.clicked.connect(compute_distances(self))
        self.compute_top_features_pushButton.clicked.connect(compute_top_features(self))