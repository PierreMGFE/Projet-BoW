...
class Ui_bow(object):
    def setupUi(self, bow):
        ...
        self.fomat_buttonGroup = QtWidgets.QButtonGroup(bow)
        self.fomat_buttonGroup.setObjectName("fomat_buttonGroup")
        self.fomat_buttonGroup.addButton(self.pdf_button)
        ...
        self.fomat_buttonGroup.addButton(self.txt_button)
        ...
        self.frequency_buttonGroup = QtWidgets.QButtonGroup(bow)
        ...
        self.factorisation_buttonGroup = QtWidgets.QButtonGroup(bow)
