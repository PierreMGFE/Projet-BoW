...
###################   END OF QT OUTPUT  ###########################
    ...
    def start_clustering(self):
        ...
        #fetch parameters
        format = self.source_format_buttonGroup.checkedButton().text().lower()

        input_param = {"freq" : self.vectorizer_buttonGroup.checkedButton().text(),
    ...
    def folder_path_dialog(self):
        ...
        folder_path = QtWidgets.QFileDialog.getExistingDirectory(self, "Choose source folder", "", options=options)
        self.source_folder_line.setText(str(folder_path))



    def file_path_dialog(self):
        options = QtWidgets.QFileDialog.Options()
        file_path = QtWidgets.QFileDialog.getOpenFileName(self, "Choose source file", "", options=options)
        self.source_folder_line.setText(str(file_path))
