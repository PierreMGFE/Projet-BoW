...
class Bow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 550, 784))
        ...
        self.source_format_2.setText(
            "If the source is PDF files, the files wil converted to TXT and saved to a subfolder for analysis.")
        ...
        self.format_buttonGroup = QtWidgets.QButtonGroup()
        self.format_buttonGroup.setObjectName("format_buttonGroup")
        self.format_buttonGroup.addButton(self.pdf_button)
        ...
        self.format_buttonGroup.addButton(self.txt_button)
        ...
        self.groupBox_3.setTitle("Parameters")
        ...
        self.word_frequency_2.setText(
            "All words present within the source will be saved as features and assigned a frequency per text.")
        ...
        self.frequency_buttonGroup = QtWidgets.QButtonGroup()
        self.frequency_buttonGroup.setObjectName("frequency_buttonGroup")
        self.frequency_buttonGroup.addButton(self.countvectorizer)
        ...
        self.frequency_buttonGroup.addButton(self.tf_idf)
        ...
        self.word_frequency_4.setText(
            "Choose minimum and maximum source frequency (proportion of files in which a feature appears) :")
        ...
        self.frequency_matrix_factorisation_2.setText(
            "The features/text matrix will be factorised to make the most important features stand out.")
        ...
        self.topic_modelling_2.setText(
            "The features will be assembled into topics that link texts containing the same frequent features.")
        ...
        self.clustering_2.setText(
            "The texts will be separated into clusters, determined by the distance between texts (calculated from the projection of the matrix on the topics).")
        ...
        self.start_clustering = QtWidgets.QPushButton(self.clustering)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setWeight(50)
        self.start_clustering.setFont(font)
        self.start_clustering.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.start_clustering.setText("Start clustering")
        self.start_clustering.setShortcut("Enter")
        self.start_clustering.setObjectName("start_clustering")
        self.verticalLayout_9.addWidget(self.start_clustering)
        ...
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.text_to_text_distance)
        self.verticalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.groupBox = QtWidgets.QGroupBox(self.text_to_text_distance)
        self.groupBox.setTitle("Parameters")
        self.groupBox.setObjectName("groupBox")
        self.verticalLayout_5.addWidget(self.groupBox)
        self.compute_distance = QtWidgets.QPushButton(self.text_to_text_distance)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setWeight(50)
        self.compute_distance.setFont(font)
        self.compute_distance.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.compute_distance.setText("Compute distance")
        self.compute_distance.setShortcut("Enter")
        self.compute_distance.setObjectName("compute_distance")
        self.verticalLayout_5.addWidget(self.compute_distance)
        ...
        self.verticalLayout_12 = QtWidgets.QVBoxLayout(self.top_features)
        self.verticalLayout_12.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_12.setObjectName("verticalLayout_12")
        self.groupBox_2 = QtWidgets.QGroupBox(self.top_features)
        self.groupBox_2.setTitle("Parameters")
        self.groupBox_2.setObjectName("groupBox_2")
        self.verticalLayout_12.addWidget(self.groupBox_2)
        self.compute_top_features = QtWidgets.QPushButton(self.top_features)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setWeight(50)
        self.compute_top_features.setFont(font)
        self.compute_top_features.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.compute_top_features.setText("Compute top features")
        self.compute_top_features.setShortcut("Enter")
        self.compute_top_features.setObjectName("compute_top_features")
        self.verticalLayout_12.addWidget(self.compute_top_features)
        ...
        # Launch Analysis
        self.start_clustering.clicked.connect(self.start_clustering_click)
    ...
    def start_clustering_click(self):
        #local launch variables
        start = False
        error_message_text = ""

        #fetch parameters
        self.format = self.format_buttonGroup.checkedButton().text().lower()

        self.input_param = {"freq" : self.frequency_buttonGroup.checkedButton().text(),
                            "df_min" : self.minimum_frequency.value()/100,
                            "df_max" : self.maximum_frequency.value()/100,
                            "n_feat" : self.number_features.value(),
                            "facto" : self.factorisation_buttonGroup.checkedButton().text(),
                            "n_topics" : self.number_topics.value(),
                            "n_top_feat" : self.number_most_important_features.value(),
                            "n_clust" : self.number_clusters.value()}
        ...
        if os.path.isdir(self.dir_path):
            ...
            if (self.format == "pdf" or self.format == "txt"):
                ...
                if len([file for file in os.listdir(self.dir_path) if file.endswith("." + self.format)]):
                    ...
                    if self.input_param["df_min"] < self.input_param["df_max"]:
                        launch = True
                    else:
                        error_message_text += "Check frequency\n"
                else:
                    error_message_text += "No " + self.format + " files in directory\n"
            else:
