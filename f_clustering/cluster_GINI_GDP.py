...
input:  excel_file
            ...
            from 2000 to 2016
            with    GINI
                    GDP per capita growth (2011 PPP)
                    

=========== ========================================================
parameters: pandas
                transform excel file into python object
...
data = pandas.read_excel(os.path.join(ROOT_DIR,"a_data/excel_data/Macroeconomic-data.xls"),skiprows=1)
